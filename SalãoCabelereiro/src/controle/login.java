...
public class login extends javax.swing.JFrame {
    ...
    private void btnLogarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogarActionPerformed
        try {
            ...
            conexaoUsu.executaSQL(pesquisa);
            
            if(conexaoUsu.resultset.first()){
                
                Home mostra = new Home(); //Criar a tela incial do sistema, a home
                mostra.setVisible(true);
                dispose();
            } else {
                
                JOptionPane.showMessageDialog(null, "\n Usuário não cadastrado!!!!", "Mensagem do Programa", JOptionPane.INFORMATION_MESSAGE);
                conexaoUsu.desconecta();
                System.exit(0);
            }
